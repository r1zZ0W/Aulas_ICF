 ...
 *
 * <p>Designed as an independent entity to support real-time availability queries.
 ...
 * triggering unnecessary lazy-load chains.</p>
 *
 * @author Ithera
 * @version 2.0
 * @see ReservInstance
...
public class ReservSlot {
     ...
     * Corresponds to {@code UNIQUE INDEX idx_unique_classroom_time (classroom_id, date, time_slot_id)}.
     */
     ...
     * Corresponds to {@code UNIQUE INDEX idx_unique_user_time (user_id, date, time_slot_id)}.
     */

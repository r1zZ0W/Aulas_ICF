 ...
 *
 * A group defines a weekly repetition pattern (days of week) for a specific user
 * within a given semester. Individual date occurrences are materialized as
 * {@link ReservInstance} records.
 *
 * @author Ithera
 * @version 1.0
 * @see ReservInstance
...
public class ReservationGroup extends BaseEntity {
     ...
     * Uses the standard {@link DayOfWeek} enum whose constant names
     * match the SQL ENUM values exactly.
     */
